      ...
      <section class="container-fluid vh-50 d-flex flex-column">
          <div class="row flex-grow-1">
              <div class="col-md-4 d-flex flex-column align-items-center justify-content-center profile-section">
                  <img src="{{ isset($data_pelanggan) && $data_pelanggan->foto_pelanggan ? url($data_pelanggan->foto_pelanggan) : asset('images.default-user.png') }}"
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <input type="password" name="old_password" id="old_password"
                                      value="{{ old('old_password') }}" class="form-control" required maxlength="255"
                                      placeholder="Required ..."><br>
                              </div>
                              <div class="col-md-6">
                                  <label for="new_password">New Password</label>
                                  <input type="password" name="new_password" id="new_password"
                                      value="{{ old('new_password') }}" class="form-control" required maxlength="255"
                                      placeholder="Required ..."><br>
                              </div>
                              <div class="col-md-12">
                                          ...
                                          <div class="card-body order-card-body">
                                              ...
                                              <div class="order-details">
                                                  <p class="mb-1">{{ $order->nama_outlet }} |
                                                      {{ date('Y-m-d', strtotime($order->tanggal)) }}
                                                  </p>
                                                  <span
                                                  ...
                                                  <p class="mt-3" style="font-size: 22px; font-weight: bold;">
                                                      {{ $order->nama_barang }}</p>
                                                  <p>{{ $order->qty }} barang x Rp.{{ number_format($order->harga) }}
                                                  </p>
                                              </div>
                                              <div class="order-actions">
                                                  <p class="order-total">Total pesanan:
                                                      Rp.{{ number_format($order->subtotal) }}</p>
                                                  @if ($order->status_order == 'WAITING_PAYMENT')
                                                      <a href="{{ route('cart.detail', $order->id) }}"
