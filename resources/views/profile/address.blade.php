              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <form method="POST" enctype="multipart/form-data" action="{{ route('address.save') }}">
                    ...
                    <input type="number" name="kodepos" class="form-control" required maxlength="255"
                    ...
                    <div class="form-group">
                      ...
                      <script type="text/javascript"
                        src="https://maps.googleapis.com/maps/api/js?key=YOUR_VALID_API_KEY&callback=initMap&libraries=places" async defer>
                      </script>
